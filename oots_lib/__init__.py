...
_LAZY_IMPORTS = {
    ...
    "TransportError": ("oots_lib.libs.exception", "TransportError"),
    "ReportingError": ("oots_lib.libs.exception", "ReportingError"),
    "LoggerServiceError": ("oots_lib.libs.toLogger", "LoggerServiceError"),
    "RedisDataError": ("oots_lib.libs.UseRedis", "RedisDataError"),
